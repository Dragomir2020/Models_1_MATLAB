...
fprintf('The period of the square wave function is %f',T);
...
plot(tmeas,Vr,'r:',tmeas,AppliedVoltage,'b:');
% Put tmeas on the x-axis and AppliedVoltage and Vr (resistor voltage) on
% the y-axis.  Add legend, title, and axis labels.
ylabel('\bfVoltage Applied','FontSize',12);
xlabel('\bftime','FontSize',12);
legend('Measured Resitor Voltage','Initial Voltage');
